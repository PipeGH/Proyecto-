               ...
               <c:forEach var="vis" items="${visitas}">       
                <tr>
                         ...
                         <td>
                             ...
                             <a class="btn btn-danger" onclick="return Eliminar()"style="margin-left: 10px"href="Controlador?menu=Visitas&accion=Eliminar&id_visita=${vis.getId_visita()}">Eliminar Datos</a>
                         </td>
               </tr>
            </c:forEach>        
           </tbody>
